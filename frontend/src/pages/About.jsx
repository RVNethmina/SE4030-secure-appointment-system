  ...
  return (
    <div>
      ...
      <div className="my-4 text-xl">
        <p className="">
          WHY <span className="font-semibold text-gray-700"></span>CHOOSE US
        </p>
      </div>

      <div className="flex flex-col mb-20 md:flex-row">
        <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col pap-5 text-[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
