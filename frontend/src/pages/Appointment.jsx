      ...
      <div>
        ...
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            {/* ----------Doc Info : name degree and expereince--------- */}
        ...
        <div className="mt-4 font-medium text-gray-700 sm:ml-72 sm:pl-4">
          ...
          <div className="flex w-full gap-3 mt-4 overflow-x-scroll item-center">
          ...
          <button onClick={bookAppointment} className="py-3 mt-4 text-sm font-light text-white rounded-full bg-primary px-14">Book an Appointment</button>
        </div>
